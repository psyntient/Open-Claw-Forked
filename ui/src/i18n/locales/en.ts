...
export const en: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      lobsterVisits: "Companion visits",
  ...
  nav: {
    ...
    vaultViewer: "Projects Dashboard",
    openProjectFiles: "Open this project\u2019s profile",
    back: "Back",
    forward: "Forward",
    chat: "Chat",
    settings: "Settings",
  ...
  subtitles: {
    ...
    vault: "Every project on this Node",
  ...
  projects: {
    ...
    dataTypesLabel: "What kind of data will this hold?",
    dataTypesHint:
      "Pick everything that applies. This decides whether the project can ever contribute to the Noetic Archive, so it is asked now rather than later.",
    eligibleYes: "Can contribute recordings to the Noetic Archive, with your consent.",
    eligibleNo: "Stays on this Node — no recordings to contribute to the Archive.",
    create: "Create project",
    createFailed: "Could not create this project.",
  ...
  update: {
    ...
    commitCount: "{n} change(s)",
    willRestart: "the Gateway will restart",
    longBuild: "a full rebuild takes about 20 minutes",
    dirty: "This Node has uncommitted local changes, so it will not update automatically.",
    failedBefore: "This update failed once and will not be retried on its own.",
    starting: "Starting\u2026",
    failed: "The update could not start.",
    autoLabel: "Check for updates automatically",
    autoHint: "Checks when the app opens. Updates are never installed without you asking.",
    // Nested, not dotted: t() resolves "update.stage.pulling" by walking the
    // object, so a flat key never matches and the raw key renders instead.
    stage: {
      checking: "Checking for changes\u2026",
      snapshot: "Saving the current build\u2026",
      pulling: "Downloading {detail}\u2026",
      fork: "Updating the engine\u2026",
      building: "Building \u2014 {detail}",
      "building-ui": "Rebuilding the interface\u2026",
      restarting: "Restarting the Gateway\u2026",
      verifying: "Checking everything came back\u2026",
      "rolling-back": "Something went wrong \u2014 restoring the previous version\u2026",
      done: "Done.",
    },
  },
  vault: {
    title: "Projects Dashboard",
    subtitle: "Every project on this Node \u2014 what it holds, and what could leave it.",
    ...
    packets: "packets",
    size: "size",
    contributableCount: "ready to contribute",
    storedAt: "{storage} \u00b7 {path}",
    searchPlaceholder: "Describe what you\u2019re looking for\u2026",
    search: "Search",
    clearSearch: "Show everything",
    stageStarting: "Opening the Vault\u2026",
    // Nested, not dotted: t() resolves "vault.stage.matching" by walking the
    // object, so a flat "stage.matching" key never matches and the raw key
    // renders instead.
    stage: {
      "reading-index": "Reading the Vault index\u2026",
      matching: "Searching {detail}\u2026",
      opening: "Opening {detail}\u2026",
    },
    searchFailed: "The search could not complete.",
    noResults: "Nothing in your Vault matches \u201c{query}\u201d.",
    resultCount: "{count} matching",
    vaultEmpty: "This Vault has no projects yet.",
    projectEmpty: "Nothing stored here yet.",
    contributable: "Ready to contribute",
    noPacketsYet: "No packets yet",
    notEligible: "No instrument data",
    lastSynced: "Sent {date}",
    submissions: "{count} sent",
    span: "{from} \u2013 {to}",
    duration: "{s}s",
    truncated: "Shown in part.",
    showingOf: "Showing {listed} of {total}.",
    material: {
      sessions: "recordings",
      notes: "notes",
      analyses: "analyses",
    ...
    attachments: "files",
    attachmentsEmpty: "File uploads are not built yet \u2014 nothing can be added here.",
    deepLinkMissing:
      "\u201c{id}\u201d is not in this Vault, so there is no profile to open. It is listed below if it exists under another name.",
    browseFiles: "Project files",
    pickFile: "Choose a file to see its details.",
  ...
  archive: {
    ...
    edition: "Edition {id}",
    noPackets:
      "This Edition ships the archetype vocabulary but no observation packets yet, so nothing here has raw evidence attached to it.",
    searchPlaceholder: "Describe an experience…",
    search: "Search",
    loading: "Reading the Archive…",
    exemplarOne: "1 exemplar",
  ...
  psyntientAccount: {
    ...
    unpaired: "Not paired",
    checking: "Checking…",
    pairedDesc: "This Node is linked to your psyntient.io account.",
    unpairedDesc: "This Node is not linked to a psyntient.io account yet.",
    unknown: "Could not read pairing status.",
    nodeId: "Node ID",
    contextId: "Account context",
    pairedAt: "Paired at",
  },
  profilePage: {
